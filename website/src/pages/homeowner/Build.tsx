  ...
  return (
    <div>
      <div style={{
        ...
        marginBottom: 32, minHeight: 240, display: 'flex', alignItems: 'flex-end',
        ...
        <div style={{position: 'relative', zIndex: 1}}>
          <h1 style={{fontSize: 36, fontWeight: 900, marginBottom: 8, color: 'white'}}>What would you like to build?</h1>
          <p style={{color: 'rgba(255,255,255,0.85)', fontSize: 16}}>Choose your project type to get started with verified professionals</p>
        </div>
      </div>
